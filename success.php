...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="register_save.php" method="post"><br>
        <?php //$id=$_REQUEST['id'];?>
        <div class="alert alert-success alert-dismissible">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <h5><i class="icon fas fa-check"></i> Alert!</h5>
          You have successfully registered to the system. Please wait within 24 hours for admin approval. An email will be sent regarding the status of your registration.
        </div>
        <input class="form-control placeholder-no-fix" type="hidden" name="id" value="<?php echo $id;?>" required />
        <div class="input-group mb-3">
          <input type="file" class="form-control" placeholder="First Name" name="first">
