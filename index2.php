...
<head>
  ...
  <style>
      body {
        background-image: url(assets/img/hero-carousel/bg.jpg);
        height: 100vh;
      }
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>SINHS</b> Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="social-auth-links text-center mb-3">
        <p>- OR -</p>
        <a href="scanner.php" class="btn btn-block btn-danger">
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <a href="register.php" class="btn btn-block btn-success">
          <i class="fa fa-plus mr-2"></i> Register
        </a>
      </div>
      <!-- /.social-auth-links -->
